...
interface MVSWrapperNextProps {
    model: MVSModel;
}

export function MVSWrapperNext({ model }: MVSWrapperNextProps) {
    ...
    // Debug state changes
    useEffect(() => {
        console.group('[MVSWrapperNext] State Update');
        console.log('Story:', {
            hasStory: !!story,
    ...
    // Debug model mount
    useEffect(() => {
        console.log('[MVSWrapperNext] Model mounted:', {
            hasModel: !!model,
    ...
    if (shouldClearPlugin || !story) {
        console.log('[MVSWrapperNext] Not rendering container:', {
            shouldClearPlugin,
            hasStory: !!story
        });
    ...
    console.log('[MVSWrapperNext] Rendering container with story');
    return (
